package rickandmortyapi.runner;
...
@SelectClasspathResource("features/rickandmortyfeatures")
@ConfigurationParameter(
        key = io.cucumber.junit.platform.engine.Constants.GLUE_PROPERTY_NAME,
        value = "rickandmortyapi.steps, rickandmortyapi.hooks"
)
@ConfigurationParameter(
